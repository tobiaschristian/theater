...
use Drupal\mailer_override_legacy_test\Form\LegacyTestEmailForm;

/**
 * Tests legacy email compatibility mode.
 *
...
class LegacyEmailTest extends SymfonyMailerTestBase {
  ...
  public function testSendLegacyEmail() {
    ...
    $this->drupalGet('admin/mailer_override_legacy_test/send');
    ...
    $this->assertReplyTo(LegacyTestEmailForm::ADDRESS_REPLY_TO);

    // Check email contents.
    // @todo Check language = French
